...
\begin{document}
	...
	\label{scenarios}
	\input{chapters/Framework/scenarios}
	\subsection{Stability-Plasticity Trade-off}
	\label{cf}
	\input{chapters/Framework/catastrophicForgetting}
	\section{Metrics}
	\label{metrics}
	\input{chapters/metrics}
	\section{Regularization}
	\label{reg0}
	\input{chapters/Regularization/regularization}
	\subsection{Regularization via Parameters}
	\label{reg01}
	\input{chapters/Regularization/parameters}
	\section{Conclusion}
	\label{conclusion}
